...
namespace WalletConnect.UI
{
    public class StatusIcon : VisualElement
    {
        ...
        public const string SuccessIconPath = "WalletConnect/Web3Modal/Icons/icon_medium_checkmark";
        ...
        {
            var asset = Resources.Load<VisualTreeAsset>("WalletConnect/Web3Modal/Components/StatusIcon/StatusIcon");
