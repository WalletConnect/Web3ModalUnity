...
namespace WalletConnect.UI
{
    public class IconLink : VisualElement
    {
        ...
        {
            var asset = Resources.Load<VisualTreeAsset>("WalletConnect/Web3Modal/Components/IconLink/IconLink");
            ...
            image = this.Q<Image>();
            if (icon == null)
                icon = Resources.Load<VectorImage>("WalletConnect/Web3Modal/Icons/icon_regular_info");
