...
namespace WalletConnect.UI
{
    public class Modal : VisualElement
    {
        ...
        public Modal()
        {
            var asset = Resources.Load<VisualTreeAsset>("WalletConnect/Web3Modal/Components/Modal/Modal");
            ...
            OrientationTracker.OrientationChanged += (_, orientation) => ConfigureLandscape(orientation);
#endif
        }
